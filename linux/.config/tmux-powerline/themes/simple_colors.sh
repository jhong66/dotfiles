...
TMUX_POWERLINE_SEG_AIR_COLOR=red
...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		"tmux_session_info green black ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}"
		"hostname green black ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}"
